...
namespace IN4MDatabase
{
    ...
    public partial class iN4MEntities : DbContext
    {
        ...
        public virtual ObjectResult<SpGetStaff_Result> SpGetStaff()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SpGetStaff_Result>("SpGetStaff");
        }
        ...
        public virtual ObjectResult<SpFilterInspection_Result> SpFilterInspection(string iStatus, string loc)
        {
            var iStatusParameter = iStatus != null ?
                new ObjectParameter("IStatus", iStatus) :
                new ObjectParameter("IStatus", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SpFilterInspection_Result>("SpFilterInspection", iStatusParameter, locParameter);
        }
